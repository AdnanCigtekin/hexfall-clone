...
namespace MapDesigner
{
    ...
    public class MapDesignerCore : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            myProperties.gameOverExplosionParticle = (GameObject)EditorGUILayout.ObjectField("Game Over Effect",myProperties.gameOverExplosionParticle, typeof(GameObject), false);
            ...
            myProperties.bombSprite = (Sprite)EditorGUILayout.ObjectField("Bomb Sprite",myProperties.bombSprite, typeof(Sprite), false);
            ...
            myProperties.ScoreToCreateBomb = EditorGUILayout.IntField("Score to Create Bomb: ", myProperties.ScoreToCreateBomb);
            myProperties.BombExplosionTime = EditorGUILayout.IntField("Turn to explode bomb: ", myProperties.BombExplosionTime);
